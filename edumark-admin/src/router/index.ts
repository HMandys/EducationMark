    ...
    children: [
      {
        ...
        meta: { title: '学校管理', icon: 'OfficeBuilding', permission: 'school:list' },
      },
      {
        path: 'grade',
        name: 'GradeList',
        component: () => import('@/views/school/grade/index.vue'),
        meta: { title: '年级管理', icon: 'Collection', permission: 'grade:list' },
      },
      {
        path: 'class',
        name: 'ClassList',
        component: () => import('@/views/school/class/index.vue'),
        meta: { title: '班级管理', icon: 'Files', permission: 'class:list' },
      },
      {
        path: 'teacher',
        name: 'TeacherList',
        component: () => import('@/views/school/teacher/index.vue'),
        meta: { title: '教师管理', icon: 'Avatar', permission: 'teacher:list' },
      },
      {
        path: 'student',
        name: 'StudentList',
      ...
      },
      {
        ...
        meta: { title: '家长管理', icon: 'UserFilled', permission: 'parent:list' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '考试管理', icon: 'Tickets', permission: 'exam:list' },
      },
      {
        path: 'knowledge-point',
        name: 'KnowledgePointList',
        component: () => import('@/views/exam/knowledge-point/index.vue'),
        meta: { title: '知识点管理', icon: 'Collection', permission: 'knowledge:list' },
      },
      {
        path: 'answer-sheet',
        name: 'AnswerSheetList',
        component: () => import('@/views/answer-sheet/index.vue'),
        meta: { title: '答题卡管理', icon: 'Picture', permission: 'answersheet:list' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '模板列表', icon: 'List', permission: 'answersheet:template:list' },
      },
      {
        path: 'edit/:id?',
        name: 'AnswerSheetTemplateEdit',
        component: () => import('@/views/answer-sheet-design/editor.vue'),
        meta: { title: '模板编辑', icon: 'Edit', hidden: true, permission: 'answersheet:template:edit' },
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '阅卷工作台', icon: 'Edit', permission: 'marking:workspace' },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '成绩查询', icon: 'List', permission: 'score:list' },
      },
    ],
  },
  {
