...
class MemoryStore:
    ...
    def bootstrap(self):
        ...
        self.data["parent_student_binds"] = [
        ...
        self.data["answer_sheet_details"] = [
        ...
        self.data["templates"] = [
            {
                ...
                "marginLeft": 10,
                "marginRight": 10,
                "headerConfig": {"title": "高一数学答题卡", "showTitle": True},
                "studentInfoConfig": {"showStudentId": True, "showName": True, "showClass": True},
                "status": 1,
                "pdfObjectName": "template/1/template.pdf",
                "pdfUrl": "/downloads/template-1.pdf",
                "templateImagePath": "template/1/image.png",
                "templateImageUrl": "https://via.placeholder.com/1200x1600?text=Template+1",
                "cornerConfig": {
                    "topLeft": {"x": 12, "y": 15},
                    "topRight": {"x": 1188, "y": 18},
                    "bottomLeft": {"x": 10, "y": 1580},
                    "bottomRight": {"x": 1185, "y": 1582},
                    "corrected": True,
                    "angle": 0.2,
                },
                "regions": [
                    {"id": 11, "templateId": 1, "regionType": 1, "regionTypeName": "考生信息", "regionName": "考生信息区", "pageNo": 1, "sortOrder": 1, "config": {"regionRole": "student_id"}},
                    {"id": 12, "templateId": 1, "regionType": 2, "regionTypeName": "选择题", "regionName": "选择题区域", "pageNo": 1, "sortOrder": 2, "questionStart": 1, "questionEnd": 20, "config": {"regionRole": "choice_block", "optionCount": 4, "questionsPerRow": 5, "layoutDirection": "row", "bubbleStyle": "circle"}},
                    {"id": 13, "templateId": 1, "regionType": 3, "regionTypeName": "主观题", "regionName": "填空题区域", "pageNo": 1, "sortOrder": 3, "questionStart": 21, "questionEnd": 25, "config": {"regionRole": "subjective_crop", "cropMode": "single-question", "enableAiMarking": True, "aiReferenceAnswer": "按标准答案给分"}},
                ],
            }
        ]
        self.data["marking_tasks"] = [
        ...
        self.data["marking_arbitrations"] = [
