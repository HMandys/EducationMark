...
-- AI 批改提供商配置表
DROP TABLE IF EXISTS ai_marking_provider;
CREATE TABLE ai_marking_provider (
    id BIGINT NOT NULL COMMENT '主键ID',
...
-- AI 批改策略配置表
DROP TABLE IF EXISTS ai_marking_policy;
CREATE TABLE ai_marking_policy (
    id BIGINT NOT NULL COMMENT '主键ID',
...
DROP TABLE IF EXISTS ai_marking_record;
CREATE TABLE ai_marking_record (
    id BIGINT NOT NULL COMMENT '主键ID',
